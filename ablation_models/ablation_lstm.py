...
def forecast_lstm_close_only(train_norm,test_norm,seq_len,epochs,hidden_size,learning_rate=1e-5,use_observed_update=True,target_step=1,output_horizon=1,):
